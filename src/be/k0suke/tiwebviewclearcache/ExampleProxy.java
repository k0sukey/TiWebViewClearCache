...
// This proxy can be created by calling Tiwebviewclearcache.createExample({message: "hello world"})
@Kroll.proxy(creatableInModule=TiwebviewclearcacheModule.class)
